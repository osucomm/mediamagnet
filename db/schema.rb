...
ActiveRecord::Schema.define(version: 20150317132216) do
  ...
  create_table "refresh_locks", force: :cascade do |t|
  ...
  add_index "refresh_locks", ["channel_id"], name: "index_refresh_locks_on_channel_id"
